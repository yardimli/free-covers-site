...
var templatePsdPath_str = "F:/GitHub/FreeKindleCovers/actions/empty-full-cover-half.psd"; // <--- !!! IMPORTANT: SET THIS PATH !!!

// Actions for initial processing of the source JPG
var ActionSet = "FreeKindleCovers";

var resizeActionName = "HalfResizeForFullCoverFront";

// Actions for processing the template PSD
var placeActionName = "HalfPlaceImageOnFullCoverBottom"; //Middle"; // Assumes this action pastes from clipboard or places a linked file
var fillActionName = "HalfFillFullCover";
